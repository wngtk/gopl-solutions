...
<tr style="text-align: left">
	<th><button type="submit" name="orderBy" value="title">Title</button></th>
	<th><button type="submit" name="orderBy" value="artist">Artist</button></th>
	<th>Album</th>
	<th><button type="submit" name="orderBy" value="year">Year</button></th>
	<th style="padding-left: 1em">Length</th>
</tr>{{range .}}
<tr>
	<td>{{.Title}}</td>
	<td>{{.Artist}}</td>
	<td>{{.Album}}</td>
	<td>{{.Year}}</td>
	<td style="padding-left: 1em">{{.Length}}</td>
</tr> {{end}}
</table>
</form>
</html>
